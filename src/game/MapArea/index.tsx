...
import {ItemType} from './Entities/Items/useItems';
import { Items } from './Entities/Items';

import * as Directions from './Entities/EntitiesDirections'
import { Point } from '../valueObjects/Position';

type Props = {
    gameState: GameState,
    gameStateDispatcher: React.Dispatch<GameStateActions>,
    char: {direction: Directions.ValidDirections, pos: Point};
...
export const MapArea = ({gameState, gameStateDispatcher, char, activeMonsters, items, itemsFrame, scale}: Props) => {
